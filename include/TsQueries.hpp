...
namespace oop {
  ...
  static const std::string CLASSES = R"(
...
(class_definition name: (_) @class.name) @class.declaration
  ...
  static const std::string INTERFACES = R"(
...
(protocol_declaration name: (_) @protocol.name) @protocol.declaration
  ...
  /* Abstract classes */
  static const std::string ABSTRACT_CLASSES = R"(
(class_declaration
  (modifiers)? @modifiers
  name: (_) @class.name
  ...
  static const std::string METHODS = R"(
...
(constructor_definition name: (_) @constructor.name) @constructor
  ...
  static const std::string INHERITANCE = R"(
(class_declaration
  name: (_) @class.name
...
(class_definition
  ...
  static const std::string IMPLEMENTS = R"(
(class_declaration
  name: (_) @class.name
  ...
  static const std::string METHOD_CALLS = R"(
(method_invocation
  object: (_)? @receiver
  name: (_) @method.name
) @method.call
...
(call_expression
  ...
  static const std::string FIELDS = R"(
(field_declaration
...
(class_variable name: (_) @field.name) @field
  ...
  static const std::string PROPERTY_ACCESS = R"(
(field_access
  object: (_) @object
  field: (_) @property
) @access
...
(attribute
  ...
  /* Static members */
  static const std::string STATIC_MEMBERS = R"(
(method_declaration
  (modifiers)? @modifiers
  name: (_) @method.name
...
(field_declaration
  ...
  static const std::string PUBLIC_MEMBERS = R"(
(method_declaration
  (modifiers)? @modifiers
  name: (_) @member.name
...
(field_declaration
  ...
  static const std::string PRIVATE_MEMBERS = R"(
(method_declaration
  (modifiers)? @modifiers
  name: (_) @member.name
...
namespace functional {
  ...
  static const std::string FUNCTIONS = R"(
...
(function_item name: (_) @function.name) @function
  ...
  static const std::string LAMBDAS = R"(
...
(closure_expression) @lambda
  ...
  static const std::string HIGHER_ORDER_FUNCTIONS = R"(
(function_declaration
  ...
  /* Function calls */
  static const std::string FUNCTION_CALLS = R"(
(call_expression
...
(call
  ...
  static const std::string PURE_FUNCTION_CANDIDATES = R"(
(function_declaration
  name: (_) @function.name
  ...
  static const std::string MAP_FILTER_REDUCE = R"(
(call_expression
  ...
  static const std::string IMMUTABLE_DECLARATIONS = R"(
...
(lexical_declaration
  ...
  static const std::string CLOSURES = R"(
(lambda_expression
  body: (block
    [
      (identifier) @captured
  ...
  static const std::string RECURSIVE_FUNCTIONS = R"(
(function_declaration
  name: (_) @function.name
  body: (block
    (call_expression
  ...
  static const std::string PATTERN_MATCHING = R"(
...
namespace procedural {
  ...
  static const std::string VARIABLES = R"(
...
(assignment_expression
  ...
  static const std::string MUTABLE_VARIABLES = R"(
(local_variable_declaration
  declarator: (variable_declarator name: (_) @var.name)
) @mutable
...
(lexical_declaration
  ...
  static const std::string CONDITIONALS = R"(
(if_statement
...
(if_expression
  ...
  static const std::string LOOPS = R"(
...
(for_of_statement) @loop.forof
  ...
  static const std::string LOOP_CONTROL = R"(
(break_statement) @control.break
(continue_statement) @control.continue
)";

  /* Switch statements */
  static const std::string SWITCH_STATEMENTS = R"(
(switch_statement
...
(call_expression
  ...
  static const std::string MUTATIONS = R"(
(assignment_expression
  left: (_) @target
  right: (_) @value
) @mutation
...
(update_expression
  ...
  static const std::string PROCEDURE_CALLS = R"(
(expression_statement
  ...
  /* Early returns */
  static const std::string EARLY_RETURNS = R"(
...
namespace common {
  ...
  static const std::string TYPE_DECLARATIONS = R"(
...
(type_declaration name: (_) @type.name) @type
  ...
  static const std::string ALL_FUNCTIONS = R"(
(function_declaration name: (_) @function.name) @function
(function_definition name: (_) @function.name) @function
...
(parameter
  ...
  /* Return statements */
  static const std::string RETURNS = R"(
(return_statement
  (_)? @return.value
) @return
)";
  ...
  /* Comments */
  static const std::string COMMENTS = R"(
(comment) @comment
...
(block_comment) @comment.block
  ...
  /* Imports/Includes */
  static const std::string IMPORTS = R"(
(import_declaration
...
(package_declaration) @package
  ...
  /* std::string literals */
  static const std::string STRINGS = R"(
(std::string_literal) @string
(template_std::string) @string.template
)";

  /* Numeric literals */
  static const std::string NUMBERS = R"(
...
(binary_literal) @number.binary
  ...
  /* Boolean literals */
  static const std::string BOOLEANS = R"(
(true) @boolean
(false) @boolean
(boolean_literal) @boolean
  ...
  static const std::string NULL_VALUES = R"(
(null_literal) @null
(nil) @null
(none) @null
)";
  ...
  /* Error handling */
  static const std::string ERROR_HANDLING = R"(
(try_statement
  body: (_) @try.body
  handler: (_)* @catch
  finalizer: (_)? @finally
...
(throw_statement
  ...
  static const std::string ANNOTATIONS = R"(
(annotation
...
(attribute
  ...
  static const std::string GENERICS = R"(
(type_arguments) @generic.args
(type_parameters) @generic.params
)";

  /* Array/List operations */
  static const std::string ARRAY_ACCESS = R"(
(array_access
  array: (_) @array
  index: (_) @index
) @access
...
(update_expression
  ...
  static const std::string IDENTIFIERS = R"(
(identifier) @identifier
)";

  /* TODO/FIXME/NOTE comments */
  static const std::string TODO_COMMENTS = R"(
(comment) @comment
(#match? @comment "(TODO|FIXME|NOTE|HACK|XXX|BUG\)\")
)";

  /* Documentation comments */
  static const std::string DOC_COMMENTS = R"(
(comment) @doc
(#match? @doc "^(///|/\\*\\*|#!|\"\"\"\)\")
)";
...
namespace utility {
  ...
  static const std::string UNUSED_PRIVATE_METHODS = R"(
(method_declaration
  (modifiers) @modifiers
  (#match? @modifiers "private")
  name: (_) @method.name
  ...
  static const std::string COMPLEX_METHODS = R"(
(method_declaration
  name: (_) @method.name
  body: (block) @body
) @complex.method
  ...
  static const std::string MAGIC_NUMBERS = R"(
(
  [
    (integer_literal)
    (float_literal)
  ...
  /* Empty blocks */
  static const std::string EMPTY_BLOCKS = R"(
(block) @empty.block
(#eq? @empty.block "{}")
)";

  /* Nested conditionals - if inside if */
  static const std::string NESTED_CONDITIONALS = R"(
(if_statement
  consequence: (block
    (if_statement) @nested
  )
  ...
  static const std::string TEST_METHODS = R"(
(method_declaration
...
(method_declaration
  ...
  /* Deprecated usage */
  static const std::string DEPRECATED = R"(
(method_declaration
  (annotation
    name: (identifier) @annotation
...
(call_expression
  ...
  static const std::string DI_CANDIDATES = R"(
(constructor_declaration
  ...
  static const std::string GOD_CLASS_CANDIDATES = R"(
(class_declaration
  name: (_) @class.name
  body: (class_body
...
static std::map<std::string, std::map<std::string, const std::string*>> registry = {
    {"oop", {
      {"classes", &oop::CLASSES},
...
inline const std::string* getQuery(const std::string& category, const std::string& name) {
